...
/**
 * Created by DOTECH on 11/08/2016.
 */

public final class RetainedFragmentManager {
     ...
     */
    public RetainedFragmentManager(FragmentManager fragmentManager, String stateMaintainerTAG) {
